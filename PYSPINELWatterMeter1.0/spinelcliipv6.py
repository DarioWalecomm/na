...
class IPv6Factory(object):
    ...
    def on_message(client, userdata, message):
        ...
        if A == "ID":
            ...
            coap_req = self.ipv6_factory.build_coap_request(src_addr, dest_addr, ipv6.COAP_TYPE_CON, ipv6.COAP_METHOD_CODE_GET, OAD_REQ_URI_BASE + '/' + OAD_FWV_REQ_URI, tkl=DEFAULT_TKL, token=oad_fwv_req_token) 
