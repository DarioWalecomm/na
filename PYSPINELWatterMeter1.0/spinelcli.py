...
def on_mqtt_message(client, userdata, message):
    ...
    if A == "ID":
        ...
        #srcIPAddress = ipv6_header.destination_address
        ...
        print(coap_req)
        pkt_MQTT = "hello"
        SpinelCliCmd.wpan_api.ip_send(coap_req)
        # instruccion a pyserial con comando 
        #print("SOLICITUD DE ID")
        #line = "coap 2020:abcd::212:4b00:29b6:8dc3 get con led"
        #SpinelCliCmd.do_coap(line = "coap 2020:abcd::212:4b00:29b6:8dc3 get con led")
    elif A  == "TIME":
